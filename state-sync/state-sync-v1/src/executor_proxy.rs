...
pub trait ExecutorProxyTrait: Send {
    ...
    fn publish_events_and_reconfig_notifications(
        &mut self,
...
impl ExecutorProxyTrait for ExecutorProxy {
    ...
    fn execute_chunk(
        ...
        if let Err(e) = self.publish_events_and_reconfig_notifications(events) {
            error!(
...
mod tests {
    ...
    fn test_pub_sub_validator_set() {
        ...
        assert_ok!(executor_proxy.publish_events_and_reconfig_notifications(reconfig_events));
    ...
    fn test_pub_sub_drop_receiver() {
        ...
        assert_err!(executor_proxy.publish_events_and_reconfig_notifications(reconfig_events));
    }
    ...
    fn test_pub_sub_no_events() {
        ...
        // Publish no events
        assert_ok!(executor_proxy.publish_events_and_reconfig_notifications(vec![]));
    ...
    fn test_pub_sub_no_reconfig_events() {
        ...
        assert_ok!(executor_proxy.publish_events_and_reconfig_notifications(vec![event]));
